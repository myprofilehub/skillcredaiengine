...
export default function Sidebar() {
  return (
    <aside className="w-64 h-screen fixed top-0 left-0 glass-panel border-r border-[#ffffff10] flex flex-col pt-8">
      ...
      <nav className="flex-1 px-4 space-y-2">
        ...
        <SidebarLink href="/text" icon="📝" label="Post Engine" />
        <SidebarLink href="/image" icon="🎨" label="Image Engine" />
        <SidebarLink href="/video" icon="🎬" label="Video Engine" />
        <SidebarLink href="/gallery" icon="🖼️" label="Creative Gallery" />
        <SidebarLink href="/calendar" icon="📅" label="Content Calendar" />
      </nav>
